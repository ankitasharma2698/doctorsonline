...
<div class="row">
    ...
    <h1 class="display-1 head2">AngioPlasty</h1>
    <p>A coronary angioplasty is a procedure used to widen blocked or narrowed coronary arteries (the main blood vessels supplying the heart).
...
If you've been admitted to hospital following a heart attack, you may need to stay in hospital for several days after the angioplasty procedure before going home.
    ...
    <div class="col-sm-6">
        <img src="images/angioplasty.jpg" class="img-fluid" width="500" height="500" alt="angiography"/>

         <div class="embed-responsive embed-responsive-16by9 my-3">
            <iframe width="560" height="315" src="https://www.youtube.com/embed/e13TGGccvT4" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>                
            </div>
